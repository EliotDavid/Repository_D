...
CREATE TABLE Board (
    ...
    boardLike INT DEFAULT 0, # DEFAULT 0 : 무슨 뜻이지?
    boardWriter INT NOT NULL,
    
    CONSTRAINT Board_FK FOREIGN KEY(boardWriter)
    REFERENCES User (id) # User에서는 id로 되어있어서 id칼럼을 써줌
);


SELECT * FROM USER;

# User테이블에 아무런 데이터도없어서 일단 User 데이터를 채워줌
INSERT INTO User(password, name, telNumber) VALUES('P!ssw0rd', 'John doe', '010-1234-7851');
INSERT INTO User(password, name, telNumber) VALUES('qwer1234', 'Jony Lee', '010-7854-1234');
INSERT INTO User(password, name, telNumber) VALUES('dkjvnkq19075', 'Dany Jam', '010-6788-7892');
INSERT INTO User(password, name, telNumber) VALUES('dkvnkqln100', 'Simmons Jack', '010-1234-1245');
INSERT INTO User(password, name, telNumber) VALUES('vnqkerq5657', 'Dohn Kim', '010-1234-1177');

INSERT INTO BOARD (boardTitle, boardContents, boardDateTime, boardWriter) 
VALUES('HelloWorld', 'Hello MySQL', now(), 2); # User라고 하는 테이블에 아이디가 1이라고 하는 애가 없기 때문이 이 데이터를 넣으려고 해도 안 들어가짐 
...
# 게시물을 작성한 적이 있는 유저의 아이디와 이름과 전화번호, 작성한 게시물 제목을 구하시오
# 
