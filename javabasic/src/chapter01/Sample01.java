...
class Sample04{
	private Sample03 sample03;
}

class Sample03{
	private Sample01 sample01;
	private Sample02 sample02;
	
	private String userDtoId;
	private String userDtoPw;
	private String userDtoPwCheck;
	private String userDtoEmail;
	private String userDtoNickName;
	private String userDtoAddress;
	private String userDtoAddressDetail;
	
	Sample03(){
		
	}
	
	Sample03(String a, String b){
		this.userDtoId = a;
		this.userDtoPw = b;
	}
	
	Sample03(String c, String d, String e, String f, Object g, Object h){
		this.userDtoEmail = c;
		this.userDtoNickName = d;
		this.userDtoAddress = e;
		this.userDtoAddressDetail = f;
...
public class Sample01 {
	...
	public static void main(String[] args) {
		...
		Sample03 sample03 = new Sample03(USERDTOID, USERDTOPW);
